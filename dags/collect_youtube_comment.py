...
collect_not_exist_video_comment = KubernetesPodOperator(
...
collect_exist_video_comment2 = KubernetesPodOperator(
    task_id="collect_exist_video_comment2", 
    image="geup/collect_exist_video_comment:test",
    #cmds=[""],
    arguments=[
        "--output_path", output_path,
...
collect_video_id >> pub_exist_video_id >> [collect_exist_video_comment, collect_exist_video_comment2]
